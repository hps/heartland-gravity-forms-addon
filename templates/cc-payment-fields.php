  ...
  (function (document, Heartland,$) {
    ...
    var hps = new Heartland.HPS({
      ...
      onTokenSuccess: function (response) {
        jQuery("#gform_<?php echo $form_id ?> #securesubmit_response").remove();
        jQuery("#gform_<?php echo $form_id ?>").append(jQuery('<input type="hidden" name="securesubmit_response" id="securesubmit_response" />').val(jQuery.toJSON(response)));
